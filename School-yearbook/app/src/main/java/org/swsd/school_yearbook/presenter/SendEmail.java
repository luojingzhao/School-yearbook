...
public class SendEmail {
    ...
    public static void send(String eMailContent,String eMailAddress) throws Exception {
        ...
        Test.add("1009224322@qq.com");
        String mEMailContent = eMailContent;
        ...
        ts.connect("smtp.qq.com","1009224322@qq.com", "bsbpfhusebfvbcda");//后面的字符是授权码，用qq密码反正我是失败了（用自己的，别用我的，这个号是我瞎编的，为了。。。。）
        // 创建邮件
...
// 指明邮件的发件人
        message.setFrom(new InternetAddress("1009224322@qq.com"));
// 指明邮件的收件人，现在发件人和收件人是一样的，那就是自己给自己发
        message.setRecipient(Message.RecipientType.TO, new InternetAddress(eMailAddress));
// 邮件的标题
        message.setSubject("同学录群发测试,By StarDustTeam");
// 邮件的文本内容
